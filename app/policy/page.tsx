...
export default function PolicyPage() {
	return (
		<main className="text-md text-gray-100 py-20 bg-black flex gap-4  md:min-h-fit font-sans flex-col ">
			<div className="max-w-5xl mx-auto grid gap-4 px-3">
				...
				<ul>
					...
					<li>
						<p>
							...
							in this Agreement) refers to Whats My Pace.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Whats My Pace, accessible from{' '}
							<a
								href="https://whatsmypace.run"
								rel="external nofollow noopener"
								target="_blank"
							>
								https://whatsmypace.run
							</a>
						</p>
					</li>
					<li>
				...
				<ul>
					<li>By email: ludvig.grenmo@gmail.com</li>
				</ul>
			</div>
		</main>
	);
